...
public class AdGroupPerformanceReport implements GenericReport{
    ...
    @XmlElement(name = "Row")
    public void setAdGroupPerformanceRows(List<AdGroupPerformanceRow> adGroupPerformanceRows) {
        this.adGroupPerformanceRows = adGroupPerformanceRows;
    }
    ...
    public String toString() {
        return "AdGroupPerformanceReport{" + "keywordPerformanceReportColumns=" + keywordPerformanceReportColumns + ", reportName=" + reportName + ", xmlns=" + xmlns + ", reportTime=" + reportTime + ", timeZone=" + timeZone + ", reportAggregation=" + reportAggregation + ", lastCompletedAvailableDay=" + lastCompletedAvailableDay + ", lastCompletedAvailableHour=" + lastCompletedAvailableHour + ", potentialIncompleteData=" + potentialIncompleteData + ", adGroupPerformanceRows=" + adGroupPerformanceRows + '}';
    }
}
