...
public class CampaignDevicePerformanceReport implements GenericReport {
    ...
    @XmlElement(name = "Row")
    public void setCampaignDevicePerformanceRows(List<CampaignDevicePerformanceRow> campaignDevicePerformanceRows) {
        this.campaignDevicePerformanceRows = campaignDevicePerformanceRows;
    }
    ...
    public String toString() {
        return "CampaignDevicePerformaceReport{" + "keywordPerformanceReportColumns=" + keywordPerformanceReportColumns + ", reportName=" + reportName + ", xmlns=" + xmlns + ", reportTime=" + reportTime + ", timeZone=" + timeZone + ", reportAggregation=" + reportAggregation + ", lastCompletedAvailableDay=" + lastCompletedAvailableDay + ", lastCompletedAvailableHour=" + lastCompletedAvailableHour + ", potentialIncompleteData=" + potentialIncompleteData + ", campaignDevicePerformanceRows=" + campaignDevicePerformanceRows + '}';
    }
