...
public class GaService {
    ...
    public Map<String, List<Map<String, Object>>> getGaReport(String reportName, String analyticsProfileId, Date startDate, Date endDate, String reqDimensions, String reqProductSegments, Integer dataSetId) {
        ...
        DerivedColumnUtils derivedColumn = new DerivedColumnUtils();
        ...
        if (datasetColumnList.size() > 0) {
            ...
            Map<String, List<Map<String, Object>>> data = derivedColumn.addDerivedColumnForGA(gaData, dataSetId, startDate, endDate, analyticsProfileId, metricsList, dimensions, productSegments, filter);
            return data;
        }
        return getResponseAsMap(gaData);
    }

    public static GetReportsResponse getGenericData(String viewId, Date startDate1, Date endDate1, Date startDate2, Date endDate2, String metrics, String dimentions, String productSegments, String filter) {
