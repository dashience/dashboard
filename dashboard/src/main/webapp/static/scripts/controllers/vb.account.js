...
//Tabs
    ...
    $scope.account = {logo: "static/img/auto/auto-mobiles-logo.png"}; //Logo Upload
...
//            $scope.editAccount($scope.accounts[0], 0);
    ...
    $scope.saveAccount = function (account) {
        if ($scope.account.logo === "static/img/auto/auto-mobiles-logo.png") {
            $scope.account.logo = "";
        }
        console.log(account)
        ...
        $http({method: account.id ? 'PUT' : 'POST', url: 'admin/user/account', data: account}).success(function (response) {
            ...
            if (response.status == true) {
                $scope.account = {logo: "static/img/auto/auto-mobiles-logo.png"};
            } else {
                if (!response.message) {
                    $scope.account = "";
                    $scope.account = {logo: "static/img/auto/auto-mobiles-logo.png"};
    ...
    $scope.editAccount = function (account, index) {
        ...
        var data = {
            ...
            logo: account.logo ? account.logo : "static/img/auto/auto-mobiles-logo.png"
        };
        $scope.account = data;
