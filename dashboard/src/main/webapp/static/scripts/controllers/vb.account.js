...
//Tabs
    ...
    $scope.account = {logo: "static/img/furniture/furnitureLogo.jpg"}; //Logo Upload
...
//            $scope.editAccount($scope.accounts[0], 0);
    ...
    $scope.saveAccount = function (account) {
        if ($scope.account.logo === "static/img/furniture/furnitureLogo.jpg") {
            $scope.account.logo = "";
        }
        console.log(account)
        ...
        $http({method: account.id ? 'PUT' : 'POST', url: 'admin/user/account', data: account}).success(function (response) {
            ...
            if (response.status == true) {
                $scope.account = {logo: "static/img/furniture/furnitureLogo.jpg"};
            } else {
                if (!response.message) {
                    $scope.account = "";
                    $scope.account = {logo: "static/img/furniture/furnitureLogo.jpg"};
    ...
    $scope.editAccount = function (account, index) {
        ...
        var data = {
            ...
            logo: account.logo ? account.logo : "static/img/furniture/furnitureLogo.jpg"
        };
        $scope.account = data;
