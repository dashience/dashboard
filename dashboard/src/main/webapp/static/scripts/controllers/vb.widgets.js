...
app.controller('WidgetController', function ($scope, $http, $stateParams, $timeout, $filter,
        localStorageService, $state, $window, $interval) {
...
//        $scope.selectDataSource(getDataSourceId);
//        getSegments(widget);
...
//        var getDataSet = widgetObj.dataSetId;
//        if (!getDataSet) {
//            return;
//        }
//        getSegments(widget);
...
//    };
//
//    $scope.selectDataSource = function (dataSourceName) {
//        if (!dataSourceName) {
//            return;
//        }
...
//            });
//        });
//        console.log("******** NEW COLUMN Y AXIS *************");
//        console.log($scope.columnY2Axis);
////
////        widget.columns.forEach(function(val, key){
////           if(val.fieldName != y1data.fieldName){
////               widget.columns.push(y1data);
////           }
////          
////        });
////        
////        console.log("widget.columns data");
////        console.log(widget.columns);
//        // added code ends 
//
//
...
//////        console.log(y1data)
////        console.log(chartTypeName)
////        var y1AxisObj = y1data;
////        var getWidgetColumn = widgetObj.columns;
////        angular.forEach(y1AxisObj, function (value, key) {
////            if (!value) {
////                return;
////            }
////            var exists = false;
////
////            getWidgetColumn.forEach(function (val, key) {
////                if (val.fieldName === value.fieldName) {
////                    exists = true;
////                    val.yAxis = 1;
////                    //alert(1);
...
////            });
////
//////            widgetObj.columns.forEach(function (val, key) {
//////                console.log(val.fieldName)
//////                console.log(value.fieldName)
//////                if (val.fieldName === value.fieldName) {//alert(1)
//////                    exists = true;
//////                    val.yAxis = 1;
//////                    if (chartTypeName == 'stackedbar') {//alert(2)
//////                        val.yAxis = null;
//////                        val.groupField = y1data.indexOf(value) + 1;
//////                    }
//////                    console.log(val.groupField)
//////                } else {
////////                    if (val.fieldName === y1data.fieldName) {//alert(3)
//////                            //alert(3)
//////                        val.yAxis = null;
//////                        val.groupField = null;
////////                    }
////////                    if (val.fieldName !== y1data.fieldName) {//alert(4)
////////                        val.yAxis = null;
////////                        val.groupField = null;
////////                    }
//////                }
...
//
//
////        widget.columns = $scope.columnY2Axis;
////        widget.columns=$scope.collectionFields;
//        console.log("********** AFTER SELECT Y2 AXIS **********************");
//        console.log($scope.columnY1Axis);
//
//
//
